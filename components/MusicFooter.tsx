...
const MusicFooter = ({  onTogglePlay ,onDetail}:{ onTogglePlay: () => void, onDetail():void}) => {

    const { musicInfo,audio ,changeMusicInfo,playMusic,removeMusic} = useMusicAudio();
    const { songs, playingUrl, isPlaying } = musicInfo
